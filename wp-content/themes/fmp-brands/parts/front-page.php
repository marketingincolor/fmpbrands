		...
		<div class="inner-content grid-x grid-margin-x grid-padding-x">
			<div class="small-12 large-10 large-offset-1 cell" >
				<div class="grid-x grid-margin-x form-inner">
					<div class="small-10 small-offset-1 medium-5 medium-offset-0 small-order-2 medium-order-1 cell">
					<?php echo do_shortcode('[ninja_form id=1]'); ?>
					</div>
					<div class="small-10 small-offset-1 medium-6 medium-offset-1 small-order-1 medium-order-2 cell">
